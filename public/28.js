...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      filters: [{ text: "Filter By DSG#", value: "dsg_id" }, { text: "Filter By Style#", value: "style_no" }, { text: "Filter By Shipper", value: "shipper_name" }, { text: "Filter By Description", value: "description" }],
      searchBy: {
        text: "Filter By DSG#",
        value: "dsg_id"
      },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios.post(route("api.report.searchCustomer"), self.form);
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c("v-text-field", {
                                  ...
                                  model: {
                                    value: _vm.searchForm.term,
                                    callback: function($$v) {
                                      _vm.$set(_vm.searchForm, "term", $$v)
                                    },
                                    expression: "searchForm.term"
                                  }
                                }),
                                _vm._v(" "),
                                _c("v-divider", {
