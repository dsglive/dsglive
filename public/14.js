...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(965)("418a00a4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-813c1186\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-813c1186\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      dialog: false,
      /* table */
      headers: [{ text: "Actions", value: "actions", align: "right", sortable: false }, { text: "Bin #", value: "code", align: "left", sortable: true }, { text: "Status", value: "active", align: "left", sortable: true }],
      items: [],
      selected: [],
      pagination: {
        sortBy: "name"
      },
      binsForm: new __WEBPACK_IMPORTED_MODULE_4_vform__["Form"]({}),
      toggleForm: new __WEBPACK_IMPORTED_MODULE_4_vform__["Form"]({
        toggle: false,
        bin_id: null
      }),
      search: "",
      deleteBinForm: new __WEBPACK_IMPORTED_MODULE_4_vform__["Form"]({
        bin_id: null
      }),
      domain: window.location.hostname,
      message: "Warning! Deleting This Bin Record Has Some Repercusion To The Sytem, Some Features That Reference To This Bin Record Will Break its Functionality Such As DSG, Logistics, Invoicing. Only Proceed If You Think There Will Be No Side Effect Of What You Will Be Doing!"
    };
  },
  watch: {
    items: {
  ...
  methods: {
    editBin: function editBin(bin) {
      vm.$router.push({ name: "edit-bin", params: { id: "" + bin.id } });
    },
    createBin: function createBin() {
      vm.$router.push({ name: "create-bin" });
    },
    toggleStatus: function toggleStatus(bin) {
      var self = this;
      self.toggleForm.toggle = bin.active;
      self.toggleForm.bin_id = bin.id;
      axios.post(route("api.bin.toggleStatus"), self.toggleForm).then(function (response) {
        console.log(response.data);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios.post(route("api.bin.index"), self.binsForm);

              case 5:
                payload = _context.sent;

                self.items = payload.data.data;
                self.binsForm = new __WEBPACK_IMPORTED_MODULE_4_vform__["Form"]({});
                _context.next = 17;
                break;
    ...
    deleteBin: function deleteBin(bin) {
      var self = this;
      self.deleteBinForm.bin_id = bin.id;
      var index = _.findIndex(self.items, { id: bin.id });
      axios.post(route("api.bin.delete"), self.deleteBinForm).then(function (response) {
        if (response.data.status === true) {
          self.$delete(self.items, index);
          var toggleModal = __WEBPACK_IMPORTED_MODULE_5_sweetalert2___default.a.mixin({
            confirmButtonClass: "v-btn blue-grey  subheading white--text",
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 3;
                _context2.next = 6;
                return axios.post(route("api.bin.massDeactivate"), toggleStatusForm);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 3;
                _context3.next = 6;
                return axios.post(route("api.bin.massActivate"), toggleStatusForm);
    ...
    [
      _c(
        ...
        [
          ...
          _c("confirm", {
            attrs: {
              callback: _vm.confirmed(_vm.deleteBin),
              message: _vm.message
            }
          })
        ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-813c1186", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-813c1186"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/pages/Bin/Index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-813c1186", Component.options)
  } else {
    hotAPI.reload("data-v-813c1186", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
